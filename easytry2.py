...
def main():
    ...
    # This downloads the raw repo files directly to your HuggingFace cache
    ...
    # Attempt to parse standard WeNet/Kaldi format
            ...
            for line in f:
                ...
                if len(parts) == 2:
                    ...
                    if not os.path.isabs(audio_path):
                        audio_path = os.path.join(testset_dir, audio_path)
                    audio_files.append((parts[0], audio_path))
    ...
    if len(audio_files) == 0:
        ...
        print(f"Contents: {os.listdir(testset_dir)}")
        return
